...
export const Facebook2 = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g clipPath="url(#a)">
      ...
      <path
        fill="#fff"
        d="M16.7 15.667 17.374 12h-3.92v-1.297c0-1.938.76-2.683 2.728-2.683a15.4 15.4 0 0 1 1.386.045V4.74c-.536-.15-1.848-.299-2.608-.299-4.01 0-5.859 1.893-5.859 5.978V12H6.627v3.667h2.474v7.98a12.027 12.027 0 0 0 4.353.265v-8.245H16.7Z"
      />
    </g>
    <defs>
      <clipPath id="a">
